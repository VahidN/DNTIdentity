...
public class UserProfileViewModel
{
    ...
    [Remote(action: "ValidateUsername", controller: "UserProfile",
    ...
    [UploadFileExtensions(FileExtensions = AllowedImages,
    ...
    [Display(Name = "نمایش عمومی ایمیل")] public bool IsEmailPublic { set; get; }
    ...
    [HiddenInput] public string Pid { set; get; }

    [HiddenInput] public bool IsAdminEdit { set; get; }
}